                            ...
                            {plans && plans?.map(plan => (
                                <th
                                    ...
                                    className={`px-8 py-6 text-center font-semibold cursor-pointer transition-all duration-200 ${selectedPlan?.name === plan.name
                                        ? "bg-gradient-to-b from-teal-50 to-cyan-50 text-teal-700"
                                ...
                                {plans.map(plan => {
                                    ...
                                    return (
                                        <td
                                            ...
                                            onClick={() => setSelectedPlan(plan)}
                                            className={`px-8 py-4 text-center cursor-pointer transition-colors ${selectedPlan?.name === plan.name ? "bg-teal-50/50" : ""
                                                }`}
                                        >
                                            {isBoolean ? (
                                                value === "true" ? (
                            ...
                            {plans.map(plan => (
                                <td
                                    ...
                                    className={`px-8 py-6 text-center font-bold cursor-pointer transition-all duration-200 ${selectedPlan?.name === plan.name
                                        ? "text-teal-700 bg-gradient-to-b from-teal-50 to-cyan-50"
                                        : "text-slate-900"
                                        }`}
                                >
                                    {plan.price}
            ...
            <div className="md:hidden space-y-4">
                {plans.map(plan => (
                    ...
                    >
                        ...
                        <p
                            className={`text-3xl font-bold mb-6 ${selectedPlan?.name === plan.name ? "text-teal-700" : "text-slate-900"
                                }`}
                        >
                            {plan.price}
                        </p>
