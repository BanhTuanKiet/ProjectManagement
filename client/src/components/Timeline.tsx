  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 p-6">
            ...
            {["day", "week", "month"].map((m) => (
              <button
                ...
                className={`cursor-pointer px-3 py-1 rounded text-sm font-medium ${
                  viewMode === m ? "bg-blue-600 text-white" : "bg-slate-200 dark:bg-slate-700 dark:text-white"
                }`}
              >
                {m.toUpperCase()}
              </button>
      ...
      <Card className="border border-slate-200 dark:border-slate-800 py-0">
        <div className="sticky top-0 z-20 flex border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950">
