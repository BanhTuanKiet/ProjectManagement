...
namespace server.Services.Task
{
    public interface ITasks
    {
        ...
        Task<int> DeleteTaskForeverAsync(int taskId);
        ...
        Task<WorklogDTO.PagedResult<WorklogDTO.TaskWorklogDTO>> GetTaskWorklogsAsync(int projectId, int taskId, int page, int pageSize);
    }
}